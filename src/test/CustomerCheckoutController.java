...
public class CustomerCheckoutController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		LoginConnect ld=new LoginConnect();
		   ...
		   {
		RequestDispatcher rd=request.getRequestDispatcher("CheckoutCLogin.jsp");//user can not login, user need to try again and again until user entered right password
