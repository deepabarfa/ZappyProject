...
<meta name="google-signin-client_id" content="739662502499-d7r5ffbalg5r1m5qe42uk1c06q2dk57d.apps.googleusercontent.com">
...
//      document.getElementById('status').innerHTML ='<p> Welcome '+response.name+'<a href=fblog.jsp?user_name='+response.name+'>Check</a>';
    window.location = 'http://localhost:8080/FileUploadDemo/Allinfo';  
...
<script type="text/javascript">
			...
			// window.location.href='success.jsp';
				  ...
				  document.getElementById("status").innerHTML = 'Welcome '+name+'!<a href=Allinfo?email='+email+'&name='+name+'/>Continue with Google login</a></p>'
