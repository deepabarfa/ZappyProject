...
#bg {
  ...
  width: 100%;
  height: 100%;
  background: url('https://imgur.com/JhvcBDY.jpg') no-repeat center center fixed;
...
<div id="bg"></div>
	...
	<form action="LoginControllerr" method="post">
		<div class="input-group">
			<input type="text" name="uid" id="username" autocomplete="off" onblur="checkInput(this)" required/>
...
<input type="submit" value="cancel" /></form></p1>
<br/><br/></div>
